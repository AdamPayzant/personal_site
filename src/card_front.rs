...
fn FrontLeft() -> impl IntoView {
    view! {
        <div class=" w-[60%] pt-10 pb-10 pl-4  h-full">
                ...
                <p class="pt-20 pr-9 pl-16">
                    ...
                    <p class="pt-12">
                        "My name is Adam Payzant, a software developer based in Ottawa, Ontario.
                         I have a Bachelor's of Computer Science. I have been a software developer
                         at Cisco for 4 years, and in that time I have resolved numerous bugs,
                         implemented many customer visible enhancements, and overhauled
                         my teams testing solutions."
                    </p>
                    <p class="pt-10">
        ...
        <div class="pt-10 pb-10">
            <div class="absolute top-5 right-5">
                <div class="flex flex-row">
                    <IconWithLink href="https://www.linkedin.com/in/adam-payzant/".to_string() icon={i::FaLinkedinBrands} />
                    <IconWithLink href="https://github.com/AdamPayzant/".to_string() icon={i::AiGithubFilled} />
                    <IconWithLink href="mailto:payzantedwardiv@gmail.com".to_string() icon={i::FaEnvelopeRegular} />
                    <IconWithLink href="resume.pdf".to_string() icon={i::FaFileRegular} />
                </div>
            </div>
...
fn ExperienceHeader(title: String, who: String, start: String, end: String) -> impl IntoView {
    view! {
        ...
        <p class="pl-3 flex">
            <div class="px-1">
                <Icon icon={i::FaCalendarDaysRegular} width="20px" height="20px" style="color: fdf6e3;"/>
            </div>
            {start} - {end}
        </p>
    }
...
#[component]
fn IconWithLink(href: String, #[prop(into)] icon: Signal<i::Icon>) -> impl IntoView {
    view! {
